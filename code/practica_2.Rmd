...
```{r message= FALSE, warning=FALSE}
data_clients <- data_clients[, c('ID', 'Year_Birth', 'Education', 'Marital_Status', 'Income', 'Kidhome', 'Teenhome',  'Dt_Customer', 'MntFruits', 'MntMeatProducts', 'MntFishProducts', 'MntSweetProducts',
...
En aquest cas tots els valors són inferior a 0,05. La variable ID no té rellevància com a dada informativa.
...
Per molt que no siguin normals, en els casos que tenim tenen una mida prou gran, per tant, podem utilitzar la prova. 
