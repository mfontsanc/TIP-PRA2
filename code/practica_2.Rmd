...
- MntFruits, MntMeatProducts, MntFishProducts, MntSweetProducts, NumWebPurchases, NumCatalogPurchases, NumStorePurchases
...
extrems_dt_customer <- boxplot(as.numeric(substring(data_clients$Dt_Customer,7,10)), main="DT_CUSTOMER")
extrems_mntFruits <- boxplot(data_clients$MntFruits, main="MntFruits")
extrems_mntFish <- boxplot(data_clients$MntFishProducts, main="MntFishProducts")
extrems_mntSweet <- boxplot(data_clients$MntSweetProducts, main = "MntSweetProducts")
